...
![](images/imageC-modified.png){width=100px}
...
The two equations below, which I use for this metric, are pretty much the standard Elo equations.  *ES* stands for expected score, *S* is actual score, and *K* is the k-factor, which is a multiplier for the amount a rating will change per round.  I am currently using a k-factor of 40.
