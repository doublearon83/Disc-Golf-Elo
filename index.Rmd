...
*MS* (margin stabilizer) is an additional (and novel) multiplier that influences how much ratings change per event.  However, unlike k-factor, which is the same for all players, the MS value is different for each player and based on how a player's rating compares to the average rating of the field.  If a players rating is low compared to the field, a very good round will cause their rating to go up a lot, but a bad round will not cause their rating to decrease.  The opposite is true for players with high ratings.  So it has the largest effect at the margins, hence the name.
