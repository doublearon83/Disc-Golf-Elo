...
for (i in 3:leyy) {
  logreg_sub1<-subset(logreg,logreg$Ev==eyy$Ev[i] & logreg$year==eyy$year[i])
  logreg_sub1$Etot<-rowSums(cbind(logreg_sub1$E,logreg_sub1$Et),na.rm=T)
  logreg_sub1<-logreg_sub1[,c(5,9)]
  logreg_sub1<-logreg_sub1[order(logreg_sub1$Etot,decreasing=T),][1:25,]
...
logreg_data_25 <- logreg_data_25[,c(5,6,7,8,9)]
